...
<body>
	...
	ID :<input type="text" name="id" value="${p0003VO.id}"><br>
	비밀번호 :<input type="text" name="pwd" value="${p0003VO.pwd}"><br>
	이름 :<input type="text" name="name" value="${p0003VO.name}"><br>
	이메일:<input type="text" name="email" value="${p0003VO.email}"><br>
